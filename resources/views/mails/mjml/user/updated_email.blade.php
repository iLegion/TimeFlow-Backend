            ...
            <mj-section background-color="#FFFFFF" padding="45px 25px">
                <mj-column>
                    ...
                    <mj-text padding-bottom="25px">
                        {{ __('mails.user.updated_email.content.main', ['value' => $system['title']]) }}
                    </mj-text>

                    <mj-text css-class="light-text" padding-bottom="15px">
                        <strong>{{ __('mails.user.updated_email.content.list.Prev email') }}</strong> {{ $oldEmail }}
                    </mj-text>

                    <mj-text css-class="light-text" padding-bottom="25px">
                        <strong>{{ __('mails.user.updated_email.content.list.New email') }}</strong> {{ $user->email }}
                    </mj-text>

                    <mj-text mj-class="light-text" font-size="15px">
                        {{ __('mails.user.updated_email.content.Not requested') }}
                    </mj-text>
                </mj-column>
            </mj-section>
