        ...
        <mj-wrapper mj-class="main-container" padding="30px 0">
            ...
            <mj-section background-color="#FFFFFF" padding="45px 25px">
                <mj-column>
                    ...
                    <mj-text>
                        {{ __('mails.user.email_verification.content.main') }}
                    </mj-text>
                </mj-column>
            </mj-section>

            <mj-section padding="0 30px">
                <mj-column background-color="#f8f8f8" border="1px solid #e0e0e0" border-radius="6px" padding="25px 0">
                    <mj-text align="center" font-size="36px" font-weight="bold" color="#1D1D1D" padding="0">
                        <strong>{{ $code }}</strong>
                    </mj-text>
                </mj-column>
            </mj-section>
