            ...
            <mj-section background-color="#FFFFFF" padding="45px 25px">
                <mj-column>
                    ...
                    <mj-text font-size="20px" font-weight="bold" padding-bottom="25px">
                        {{ __('mails.main.hi', ['value' => $user->name]) }}
                    </mj-text>
                    ...
                    <mj-text font-weight="bold" font-size="18px" padding-bottom="20px">
                        {{ __('mails.user.registered.content.list.Where to start') }}
                    </mj-text>

                    <mj-text padding="0 15px 15px 15px">
                    ...
                    <mj-button href="{{ $system['url'] }}" align="center">
